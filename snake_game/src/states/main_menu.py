...
class MainMenu:
    ...
    def _draw_snake_preview(self, surface):
        ...
        pygame.draw.rect(surface, (80, 80, 100), (preview_x, preview_y, preview_width, preview_height), 2, border_radius=10)
        ...
        if body_image:
            ...
            # 绘制蛇身段（2个身体段）
            for i in range(2):
                body_x = preview_center_x - (i + 1) * 45
            ...
            body_radius = 12
            for i in range(3):
                body_x = preview_center_x - (i + 1) * 30
